# Сценарии тестов для стандартной покупки тура и покупки в кредит
...
* Ожидаемый результат при заполнении формы невалидными данными: после нажатия кнопки Отправить запрос не отправляется, появляется сообщение Неверно указан срок действия карты
...
* Ожидаемый результат при заполнении формы невалидными данными: после нажатия кнопки Отправить запрос не отправляется, появляется сообщение Истек срок действия карты
